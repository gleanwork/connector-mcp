    ...
    content: [
      {
        type: 'text' as const,
        text: [
          "Let's get started building your Glean connector.",
          '',
          'First, run `check_prerequisites` to verify your environment is ready (uv, Python, mise, copier, and Glean credentials).',
          '',
          ...
          formatNextSteps([
            {
              ...
              description:
                'verify uv, python, mise, copier, and Glean credentials are configured',
