...
export const GLEAN_DOCUMENT_FIELDS: readonly GleanField[] = [
  {
    ...
    type: 'string',
    required: true,
    description: 'Unique object ID within the datasource',
  },
  {
    name: 'title',
    type: 'string',
  ...
  },
  {
    ...
    type: 'string',
    required: true,
    description: 'Canonical URL for viewing the document',
  },
  {
    name: 'permissions',
    type: 'object',
    required: true,
    description: 'Document access permissions (e.g. anonymous access flag)',
  },
  {
    name: 'body',
    type: 'string',
    required: false,
    description: 'Document body text (plain text or HTML)',
  },
  {
    name: 'author',
    type: 'string',
  ...
  },
  {
    ...
    type: 'string',
    required: false,
    description: 'Parent container name (e.g. folder, channel)',
  },
  {
    name: 'mimeType',
    type: 'string',
...
export const REQUIRED_GLEAN_FIELDS: readonly string[] =
  GLEAN_DOCUMENT_FIELDS.filter((f) => f.required).map((f) => f.name);
